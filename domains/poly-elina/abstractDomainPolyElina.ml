(** file abstractDomainPolyElina.ml
...
(* the octagon manager *)
let manoct = Elina_poly.manager_alloc_loose ()
...
type abstractOctagon = Elina_poly.loose Elina_poly.t Apron.Abstract1.t

(*Oct.t Apron.Manager.t (*Elina_poly.t Apron.Abstract1.t *)*)
