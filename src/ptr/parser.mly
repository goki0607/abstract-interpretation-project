...
%token PLUS MINUS LT EQ NEQ GT NAND LPAREN RPAREN ASSIGN DEREF ADDR NULL /* lexer tokens */
...
stmt:
  ...
  | DEREF p = IDENT ASSIGN a = aexpr SEMICOLON { AssignP (p, a, ()) }
  | SEMICOLON                              { Emptystmt () }
